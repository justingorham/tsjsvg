...
@justingorham/tsjsvg/1.0.2 win32-x64 node-v12.14.1
$ tsjsvg --help [COMMAND]
USAGE
  $ tsjsvg COMMAND
...
...
_See code: [src\commands\generate.ts](https://github.com/justingorham/ts-json-schema-validator-generator/blob/v1.0.2/src\commands\generate.ts)_
