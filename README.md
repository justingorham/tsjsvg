...
@justingorham/tsjsvg/1.0.3 win32-x64 node-v12.14.1
$ tsjsvg --help [COMMAND]
USAGE
  $ tsjsvg COMMAND
...
...
_See code: [src\commands\generate.ts](https://github.com/justingorham/tsjsvg/blob/v1.0.3/src\commands\generate.ts)_
